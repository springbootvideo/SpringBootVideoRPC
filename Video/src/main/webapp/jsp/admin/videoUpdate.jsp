...
<body>
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" class="form-horizontal" action="<%=basePath%>admin/videoAlter.do">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="title" id="subjectTitle"
						value="${video.title }" placeholder="课程标题" type="text">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<select name="speakerId" id="speakerId" class="form-control">
						...
						<c:forEach var="speaker" items="${speakerList}">
							<option value="${speaker.id}" <c:if test="${speaker.id==video.speakerId }"> selected </c:if>>${speaker.speakerName}</option>
						</c:forEach>
				...
				<div class="col-sm-10">
					...
					<select name="courseId" id="courseId" class="form-control">
						...
						<c:forEach var="course" items="${courseList}">
							<option value="${course.id}" <c:if test="${course.id==video.courseId }"> selected </c:if>>${course.courseTitle}</option>
						</c:forEach>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="time" id="time"
						value="${video.time }" placeholder="精确到秒（正整数）" type="text">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="imageUrl"  id="imageUrl"
						value="${video.imageUrl }" placeholder="具体url" type="text">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="videoUrl" id="videoUrl"
						value="${video.videoUrl }" placeholder="具体url" type="text">
				</div>
			</div>
			<div class="form-group">
